...
| 4  | SSH   | `ros2 service call /slam_toolbox/save_map slam_toolbox/srv/SaveMap "{name: \"/home/eddy/ros2_ws/maps/slamdunk\"}"`<br>
`ros2 run nav2_map_server map_saver_cli -f slamdunk`| 맵 저장          |
